...
},{"./lib/github":6}],4:[function(require,module,exports){
'use strict';
...
},{"atob":1,"btoa":2}],5:[function(require,module,exports){
'use strict';
...
},{"./base64":4}],6:[function(require,module,exports){
'use strict';
...
module.exports = function () {
  ...
  _createClass(GitHub, [{
    ...
    value: function getBlob() {
      ...
      return request.get('https://api.github.com/repos/' + owner + '/' + repo + '/git/blobs/' + sha).set('Authorization', 'token ' + this.token).then(function (res) {
        return res.body;
      });
    }
    ...
    value: function getCommit() {
      ...
      return request.get('https://api.github.com/repos/' + owner + '/' + repo + '/git/commits/' + sha).set('Authorization', 'token ' + this.token).then(function (res) {
        return res.body;
      });
    }
    ...
    value: function getTree() {
      ...
      var repo = _ref4.repo;
      var sha = _ref4.sha;
      var recursive = _ref4.recursive;

      var req = request.get('https://api.github.com/repos/' + owner + '/' + repo + '/git/trees/' + sha).set('Authorization', 'token ' + this.token);
    ...
    value: function getReference() {
      ...
      return request.get('https://api.github.com/repos/' + owner + '/' + repo + '/git/refs/heads/' + ref).set('Authorization', 'token ' + this.token).then(function (res) {
        var body = res.body;
    ...
    value: function createTree() {
      ...
      var repo = _ref6.repo;
      var tree = _ref6.tree;
      var base_tree = _ref6.base_tree;

      return request.post('https://api.github.com/repos/' + owner + '/' + repo + '/git/trees').set('Authorization', 'token ' + this.token).send({ tree: tree, base_tree: base_tree }).then(function (res) {
        return res.body;
      });
    }
    ...
    value: function createCommit() {
      ...
      return request.post('https://api.github.com/repos/' + owner + '/' + repo + '/git/commits').set('Authorization', 'token ' + this.token).send({ message: message, tree: tree, parents: parents }).then(function (res) {
        return res.body;
      });
    }
    ...
    value: function updateReference() {
      ...
      return request.patch('https://api.github.com/repos/' + owner + '/' + repo + '/git/refs/heads/' + ref).set('Authorization', 'token ' + this.token).send({ sha: sha, force: force }).then(function (res) {
        return res.body;
      });
    }
    ...
    value: function repo() {
      ...
      var _repo = _ref9.repo;
      var branch = _ref9.branch;
      var commitPrefix = _ref9.commitPrefix;

      return new Repo({ github: this, owner: owner, repo: _repo, branch: branch, commitPrefix: commitPrefix });
    }
  }]);
...
},{"./promise":8,"./repo":9,"superagent":17}],7:[function(require,module,exports){
'use strict';
...
module.exports = function (_Blob) {
  _inherits(JSONBlob, _Blob);

  function JSONBlob() {
    _classCallCheck(this, JSONBlob);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(JSONBlob).apply(this, arguments));
  }

  _createClass(JSONBlob, [{
    key: 'content',
    ...
    set: function set(value) {
      _set(Object.getPrototypeOf(JSONBlob.prototype), 'content', stringify(value, { space: '\t' }) + '\n', this);
    }
  }]);
...
},{"./blob":5,"json-stable-stringify":13}],8:[function(require,module,exports){
'use strict';

try {
  Promise;
} catch (err) {
  throw new Error('git-data.js requires a Promise implementation to be present globally.');
}
...
var Blob = require('./blob');
var JSONBlob = require('./json-blob');
var co = require('co');
...
var isDirectChild = _require.isDirectChild;
var removeElement = _require.removeElement;
...
module.exports = function () {
  ...
  _createClass(Repo, [{
    ...
    value: function _wrapGithub(method) {
    ...
    value: function readFile() {
      ...
      var FileType = arguments.length <= 1 || arguments[1] === undefined ? Repo.detectFileType(path) : arguments[1];
      return co(regeneratorRuntime.mark(function _callee2() {
        var tree, info, res, json, b;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt('return', this._blobCache[path]);
              ...
              case 4:
                tree = _context2.sent;
                info = tree.tree.find(function (info) {
                  return info.path === path && info.type === 'blob';
                });
              ...
              case 8:
                _context2.next = 10;
                return this._wrapGithub('getBlob', { sha: info.sha });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt('return', this._blobCache[path]);
              ...
              case 9:
                ...
                _b = new FileType(json);

                this._blobCache[path] = _b;
                return _context3.abrupt('return', _b);

              case 16:
                b = new FileType({ path: path });
    ...
    value: function deleteFile() {
      ...
      return co(regeneratorRuntime.mark(function _callee4() {
        ...
        var blob, tree, info, segments, _segments$map$reverse, _segments$map$reverse2, parentDirs, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _loop, _iterator, _step, _ret;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 12:
                ...
                segments = path.split('/');
                _segments$map$reverse = segments.map(function (seg, i) {
                  if (i === 0) return seg;
                  return segments.slice(0, i).join('/') + '/' + seg;
                }).reverse().concat('');
                _segments$map$reverse2 = _toArray(_segments$map$reverse);
                parentDirs = _segments$map$reverse2.slice(1);

                // remove file from tree cache

                removeElement(tree.tree, function (i) {
                  return i.path === path;
                });
                    ...
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          ...
                          t = tree.tree.filter(function (i) {
                            return isDirectChild(dir, i.path);
                          });

                          // convert all paths to basenames

                          t = t.map(function (info) {
                            var o = {};
                            merge(o, info);
                        ...
                        case 6:
                          _context4.next = 8;
                          return _this._wrapGithub('createTree', { tree: t });
                ...
                _iterator = parentDirs[Symbol.iterator]();
        ...
        }, _callee4, this, [[20, 33, 37, 45], [38,, 40, 44]]);
      }).bind(this));
    }
  }, {
    key: 'commit',
              ...
              case 0:
                ...
                blobs = blobPaths.map(function (path) {
                  return {
                    ...
                    mode: '100644',
                    type: 'blob',
                    content: _this2._blobCache[path].decodedContent
                  };
                });
    ...
    key: 'detectFileType',
    value: function detectFileType(path) {
...
},{"./blob":5,"./json-blob":7,"./promise":8,"./util":10,"co":11}],10:[function(require,module,exports){
'use strict';
...
exports.isDirectChild = function isDirectChild(path1, path2) {
  ...
  return parts1.length + 1 === parts2.length && parts1.join('') === parts2.slice(0, -1).join('');
};
...
},{"jsonify":14}],14:[function(require,module,exports){
...
},{"./is-object":18,"./request":20,"./request-base":19,"emitter":12}],18:[function(require,module,exports){
/**
