 ...
 * const repo = github.repo('nucleartide', 'slots-data-dev', 'master')
 */
module.exports = class GitHub {
  ...
  createTree({ owner, repo, tree = [], base_tree, recursive } = {}) {
    const token = this.token
    let req = request
  ...
  /**
   * Generate a repo to use the high-level file system API.
   */

  repo({ owner, repo, branch }) {
    return new Repo({ github: this, owner, repo, branch })
  }
}
